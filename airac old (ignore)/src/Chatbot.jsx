        ...
        <div className="chat-content">
          ...
          <div className="messages-container">
            {messages.map((message) => (
              <div
                key={message.id}
                className={`message-wrapper ${message.isUser ? 'user-message-wrapper' : 'bot-message-wrapper'}`}
              >
                {!message.isUser && (
                ...
                >
                  ...
                  <p className={`message-time ${message.isUser ? 'user-time' : 'bot-time'}`}>
            ...
            {isTyping && (
              <div className="message-wrapper bot-message-wrapper">
                <div className="avatar bot-avatar">
                  <Bot className="avatar-icon typing-bot-icon" />
                </div>
